...
public class Amaurot : AbstractDungeon
{
    ...
    private static readonly HashSet<uint> MeteorRain = [15556, 15558];
    private static readonly Vector3 MeteorRainLocation = new(-99.49644f, 748.2327f, 101.4963f);

    private static readonly HashSet<uint> Apokalypsis = [15575, 15577];
    private static readonly HashSet<uint> TherionCharge = [15578];
